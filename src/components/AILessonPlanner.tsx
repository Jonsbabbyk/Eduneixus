...
    try {
      const response = await fetch(import.meta.env.VITE_API_URL + '/api/generate-lesson-plan', {
        method: 'POST',
        headers: {
...
    try {
      const response = await fetch(import.meta.env.VITE_API_URL + '/api/export-lesson-plan-pdf', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
